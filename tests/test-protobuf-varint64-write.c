...
uint64_t  DATA_01 = 0;
size_t  LENGTH_01 = 1;
uint8_t  EXPECTED_01[] = "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";

uint64_t  DATA_02 = 1;
size_t  LENGTH_02 = 1;
uint8_t  EXPECTED_02[] = "\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00";

uint64_t  DATA_03 = 300;
size_t  LENGTH_03 = 2;
uint8_t  EXPECTED_03[] = "\xac\x02\x00\x00\x00\x00\x00\x00\x00\x00";

uint64_t  DATA_04 = UINT64_C(5000000000);
size_t  LENGTH_04 = 5;
uint8_t  EXPECTED_04[] = "\x80\xe4\x97\xd0\x12\x00\x00\x00\x00\x00";

uint64_t  DATA_05 = -500;
size_t  LENGTH_05 = 5;
uint8_t  EXPECTED_05[] =
    "\x8c\xfc\xff\xff\xff\xff\xff\xff\xff\x01";

uint64_t  DATA_06 = UINT64_C(-5000000000);
size_t  LENGTH_06 = 5;
uint8_t  EXPECTED_06[] =
...
test_suite()
{
    Suite  *s = suite_create("protobuf-varint64-write");

    TCase  *tc = tcase_create("protobuf-varint64-write");
